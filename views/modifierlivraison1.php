...
<div class="col-md-6">
    ...
    <div class="panel-body">
        <form method="POST" action="ajoutlivraison.php">
          ...
          <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> Modifier Livraison</h3>
                    <div class="form-group ">
                        <label class="control-label" for="success">Saisir l'id client</label>
                        <input type="number" class="form-control" id="success" name="idclient" required="" placeholder="id client" value="<?PHP echo $idclient ?>"/>
                    </div>
                    <div class="form-group ">
                        <label class="control-label" for="warning">saisir l'id livreur</label>
                        <input type="text" class="form-control" id="warning" name="idlivreur" required="" placeholder="id livreur" value="<?PHP echo $idlivreur ?>"/>
                    </div>
                    <div class="form-group ">
                        <label class="control-label" for="error">saisir l'adresse</label>
                        <input type="text" class="form-control" id="error" name="adresse" required="" placeholder="adresse" value="<?PHP echo $adresse ?>"/>
                    </div>
          <div class="form-group">
                        <label class="control-label" for="success">Saisir le numero du telephone</label>
                        <input type="number" class="form-control" id="success" name="numtel" required="" placeholder="numero" value="<?PHP echo $numtel ?>"/>
                    </div>
           <div class="form-group">
                        <label class="control-label" for="warning">saisir le numero de la commande</label>
                        <input type="number" class="form-control" id="warning" name="numcommande" required="" placeholder="commande" value="<?PHP echo $numcommande ?>"/>
                    </div>
...
if (isset($_POST['modifier'])){
  $livraison=new livraison($_POST['idclient'],$_POST['idlivreur'],$_POST['adresse'],$_POST['numtel'],$_POST['numcommande']);
