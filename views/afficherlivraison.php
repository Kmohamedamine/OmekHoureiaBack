    ...
    <li class="nav-item">
      ...
      <ul class="dropdown-menu dropdown-menu-right">
       <li class="dropdown-item user-details">
        ...
        <li class="dropdown-divider"></li>
        <li class="dropdown-item"><a class="zmdi zmdi-balance" href="contactus.php"></a> Front</li>
        <li class="dropdown-divider"></li>
  ...
  <div class="content-wrapper">
	...
	<div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Affichage des Livraisons</h5>
...
foreach($listelivraisons as $row){
	...
	<td><a href="modifierlivraison1.php?idclient=<?PHP echo $row['idclient']; ?>">
	Modifier</a></td>
            </tr>
    ...
    ?>
      ...
      <div class="row mt">
         ...
         <label style="color: black" >vous avez <h7 style="color:#00CED1"><?php echo $nbliv;?></h7> Livraisons </label>
            </div>
          </div>
        </div>

         <form class="form-inline" method="POST" action="rechercherlivraison.php" >
                      <fieldset >

                      <div class="form-group">
                  <label style="color: black" for="id">Saisir l'id de la livraison à rechercher:</label><br>
                  <input class="form-control" type="text" name="id_l" id="id_l" placeholder="id:livraison a rechercher">
