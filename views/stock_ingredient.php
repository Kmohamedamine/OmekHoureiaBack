               ...
               <table class="table table-striped">
                  ...
                  <?PHP
                    ...
                    <tr>
                      ...
                      <td><?PHP echo $row['libelle_ing']; ?></td>
                      <td><?PHP echo $row['qte_ing']; ?></td>
                      
                      <td><form method="POST" action="supprimer_ingredient.php">
                      <button type="submit" name="supprimer"  class="btn btn-light btn-round px-5"> Supprimer </button>
                      <input type="hidden" value="<?PHP echo $row['code_ing']; ?>" name="code_ing">
                      </form>
                    </td>
                    <td><a href="form_modifier_ingredient.php?id=<?PHP echo $row['code_ing']; ?>">
                    Modifier</a></td>
                    </tr>
                    <?PHP
                    }
