...
$listefournisseur = $fournisseur1c->rechercher_fournisseur_par_nom_prenom_code($recherche);
}
...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    ...
    <label for="input-6">Chercher un fournisseur</label>
          ...
          <div class="card">
            <div class="card-body">
             ...
             <a href="javascript:void();" class="dropdown-toggle dropdown-toggle-nocaret" data-toggle="dropdown" aria-expanded="false">
              ...
              <a class="dropdown-item" href="form_ajouter_ingredient.php">Ajouter un fournisseur</a>
