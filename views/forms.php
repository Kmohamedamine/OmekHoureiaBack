  ...
  <div class="content-wrapper">
    ...
    <div class="row mt-3">
      <div class="col-lg-6">
         <div class="card">
           <div class="card-body">
           <div class="card-title"> Ajouter livreur</div>
           <hr>
    ...
    <div class="panel-body">
        <form role="form">
                    <div class="form-group has-success">
                        ...
                        <input type="number" class="form-control" id="success" name="cin"/>
                    </div>
        ...
        <div class="form-group">
                    ...
                    <input type="submit" name="ajouter" class="btn btn-light btn-round px-5" value="ajouter" >
                </form>
         </div>
         </div>
      </div>
