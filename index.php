...
$listecommand=$commandc1->affichercommand_achat();
?>
<!DOCTYPE html>
<html lang="en">
<head>
         ...
         <table class="table align-items-center table-flush table-borderless">
                  <thead>
                   <tr>
                     ...
                     <th>Ingredient</th>
                     <th>Nom et Prenom de fournisseur</th>
                   </tr>
                   </thead>
                    <?PHP
                   ...
                   <tbody><tr>
                    ...
                    <td><form method="POST" action="views/supprimer_command_achat.php">
                    ...
                    <td><a href="views/form_modifier_command_achat.php?id=<?PHP echo $row['code_achat']; ?>">
                    Modifier</a></td>
                   </tr>
                  <?PHP
                      }
